...
// Expenses are now derived from activities with a 'cost'
...
export const viaje: TripDetails = {
  ...
  ciudades: [
    { id: 'static-madrid', name: "Madrid", country: "España", arrivalDate: "2025-09-12", departureDate: "2025-09-16", coordinates: { lat: 40.416775, lng: -3.703790 }, budget: 1500 },
    { id: 'static-barcelona', name: "Barcelona", country: "España", arrivalDate: "2025-09-16", departureDate: "2025-09-20", coordinates: { lat: 41.3851, lng: 2.1734 }, budget: 1200 },
    { id: 'static-valencia', name: "Valencia", country: "España", arrivalDate: "2025-09-20", departureDate: "2025-09-23", coordinates: { lat: 39.4699, lng: -0.3763 }, budget: 800 },
    { id: 'static-granada', name: "Granada", country: "España", arrivalDate: "2025-09-23", departureDate: "2025-09-26", coordinates: { lat: 37.1773, lng: -3.5986 }, budget: 700 },
    { id: 'static-sevilla', name: "Sevilla", country: "España", arrivalDate: "2025-09-26", departureDate: "2025-09-29", coordinates: { lat: 37.3891, lng: -5.9845 }, budget: 900 },
    { id: 'static-lisboa', name: "Lisboa", country: "Portugal", arrivalDate: "2025-09-29", departureDate: "2025-10-03", coordinates: { lat: 38.7223, lng: -9.1393 }, budget: 1000 },
    { id: 'static-roma', name: "Roma", country: "Italia", arrivalDate: "2025-10-03", departureDate: "2025-10-07", coordinates: { lat: 41.9028, lng: 12.4964 }, budget: 1300 },
    { id: 'static-paris', name: "París", country: "Francia", arrivalDate: "2025-10-07", departureDate: "2025-10-11", coordinates: { lat: 48.8566, lng: 2.3522 }, budget: 1600 },
    { id: 'static-cairo', name: "El Cairo", country: "Egipto", arrivalDate: "2025-10-11", departureDate: "2025-10-15", coordinates: { lat: 30.0444, lng: 31.2357 }, notes: "Visita a Egipto, detalles por confirmar.", budget: 1000 },
  ],
  paises: ["España", "Portugal", "Italia", "Francia", "Egipto"],
  activities: initialActivities, // activities are managed by Firestore primarily
